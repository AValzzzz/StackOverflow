...
static const ShopItemInfo ITEMS[ITEM_COUNT] = {
    ...
    [ITEM_REDUNDANT_COLOR] = { "Redundant Color",         "Clubs=Spades, Hearts=Diamonds for Same Suit (half points unless exact suit)", 7, true  },
    ...
    [ITEM_CACHE_BOOST]        = { "Cache Boost",          "Center cell combo bonus rises from 1.5x to 2x", 6, true },
    [ITEM_LOOP_UNROLL]        = { "Loop Unroll",          "High-card combo bonus scales 1.5x harder",    6, true },
